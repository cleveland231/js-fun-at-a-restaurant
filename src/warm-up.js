...
var vegetables = ['brocoli', 'onion', 'zuchini', 'cucumber', 'tomato'];
...
// different fruits.
var fruits = ['apple', 'bananna', 'mango', 'coconut', 'strawberry', 'orange', 'lemon'];
...
groveryStore.location = 'Denver, Colorado';
